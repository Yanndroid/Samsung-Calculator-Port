...
.method private b()V
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/i;->f0:Landroidx/recyclerview/widget/e$b;

    invoke-virtual {v5, v4, v1}, Landroidx/recyclerview/widget/e$b;->b(Landroidx/recyclerview/widget/i;Z)V
...
.method private c(Landroidx/recyclerview/widget/e$c;J)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/i$b0;->p()Z
...
.method static e(Landroidx/recyclerview/widget/i;I)Z
    ...
    invoke-static {v3}, Landroidx/recyclerview/widget/i;->J(Landroid/view/View;)Landroidx/recyclerview/widget/i$b0;
...
.method private h(Landroidx/recyclerview/widget/i;J)V
    ...
    :cond_1
    iget-object v0, p1, Landroidx/recyclerview/widget/i;->f0:Landroidx/recyclerview/widget/e$b;

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1}, Landroidx/recyclerview/widget/e$b;->b(Landroidx/recyclerview/widget/i;Z)V
    ...
    iget-object v1, p1, Landroidx/recyclerview/widget/i;->g0:Landroidx/recyclerview/widget/i$y;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroidx/recyclerview/widget/i$y;->c(Landroidx/recyclerview/widget/i$g;)V
...
.method private i(Landroidx/recyclerview/widget/i;IJ)Landroidx/recyclerview/widget/i$b0;
    ...
    :cond_0
    iget-object p0, p1, Landroidx/recyclerview/widget/i;->c:Landroidx/recyclerview/widget/i$u;

    const/4 v0, 0x0

    :try_start_0
    invoke-virtual {p1}, Landroidx/recyclerview/widget/i;->d0()V

    invoke-virtual {p0, p2, v0, p3, p4}, Landroidx/recyclerview/widget/i$u;->A(IZJ)Landroidx/recyclerview/widget/i$b0;

    move-result-object p2

    if-eqz p2, :cond_2

    invoke-virtual {p2}, Landroidx/recyclerview/widget/i$b0;->p()Z
    ...
    invoke-virtual {p0, p3}, Landroidx/recyclerview/widget/i$u;->t(Landroid/view/View;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p2, v0}, Landroidx/recyclerview/widget/i$u;->a(Landroidx/recyclerview/widget/i$b0;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_2
    :goto_0
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/i;->f0(Z)V
...
.method f(Landroidx/recyclerview/widget/i;II)V
    ...
    :cond_0
    iget-object p0, p1, Landroidx/recyclerview/widget/i;->f0:Landroidx/recyclerview/widget/e$b;

    invoke-virtual {p0, p2, p3}, Landroidx/recyclerview/widget/e$b;->d(II)V
...
.method public run()V
    ...
    invoke-static {v2}, Ls/a;->a(Ljava/lang/String;)V
