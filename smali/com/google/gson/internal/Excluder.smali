...
.method private h(Lv0/c;)Z
    .locals 2

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lv0/c;->value()D

    move-result-wide v0

    iget-wide p0, p0, Lcom/google/gson/internal/Excluder;->b:D
...
.method private i(Lv0/d;)Z
    .locals 2

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lv0/d;->value()D
...
.method private j(Lv0/c;Lv0/d;)Z
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/gson/internal/Excluder;->h(Lv0/c;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lcom/google/gson/internal/Excluder;->i(Lv0/d;)Z
...
.method public c(Ljava/lang/Class;Z)Z
    ...
    invoke-direct {p0, v0, v2}, Lcom/google/gson/internal/Excluder;->j(Lv0/c;Lv0/d;)Z
    ...
    :cond_3
    iget-object p0, p0, Lcom/google/gson/internal/Excluder;->g:Ljava/util/List;
...
.method public d(Ljava/lang/reflect/Field;Z)Z
    ...
    invoke-interface {v0}, Lv0/a;->serialize()Z
    ...
    :cond_3
    invoke-interface {v0}, Lv0/a;->deserialize()Z
